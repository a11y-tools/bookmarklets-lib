...
function createBookmarkletHref (name, url) {
  ...
  return "javascript:if(" + bookmarklet + ")" + bookmarklet + ".run();else{var%20isA11yBookmarklet=true;(function(){var%20link=document.createElement('link');link.rel='stylesheet';link.type='text/css';link.href='" + baseUrl + "build/styles.css';document.getElementsByTagName('head')[0].appendChild(link);var%20script=document.createElement('script');script.src='" + baseUrl + "build/" + scriptname + "';document.getElementsByTagName('head')[0].appendChild(script);})();}";
}
